...
Мне кажется это весьма интересным, так как значит, что внешняя зависимость не приводит к росту итогового бинарного результата. Но почему, если это как минимум тоже самое по объему кода, если еще забыть про тесты в пакете?
