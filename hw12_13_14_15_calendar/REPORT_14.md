...
Все 10 из оставшихся 20 из 30 (тестовых) кандидатов на рассылку обработаны Рассыльщиком и помещены в соответствующую очередь отосланных и архивированных (я выбрал такую логику в томчисле для демонстрации универсальности `Перекладчика`).
