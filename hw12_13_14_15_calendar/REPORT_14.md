...
Все 10 из оставшихся 20 из 30 (тестовых) кандидатов на рассылку обработаны Рассыльщиком и помещены в соответствующую очередь отосланных и архивированных (я выбрал такую логику в томчисле для демонстрации универсальности `Перекладчика`). И осталось еще 10 уведомлений, которые будут разосланы позже (заведомо извесные по тестовым данным).
