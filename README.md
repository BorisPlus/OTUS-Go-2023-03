...
2) [«Распаковка строки»](./hw02_unpack_string) - [применил подход `порождающей грамматики` (последовательная цепочка указателей от `лексемы` к `лексеме`)](./hw02_unpack_string/REPORT.md)
