...
5) [«Параллельное исполнение»](./hw05_parallel_execution)
   ...
   > [Исполнено](./hw05_parallel_execution/REPORT.md). Для демонстрации работы реализовал структуру учета статистики исполнения. Она также принимает решение о критерии останова и вносит правки в количество воркеров, если задач априори меньше заданного числа горутин. Покрыта тестами. В конце "борьба" между наглядностью и малым объемом кодовой базы (как ни странно, в данном примере они диаметрально противоположны).
